...
public class MigrateToGitOptions implements IOptionSource {
  ...
  public Options getOptions() throws ConflictingOptionException {
    ...
    options.addOption(
        new PositionalOptionDefinition(OPT_SRC_WS, "source-workspace-name", 1, 1), "name of the pre configured source workspace to change"); //$NON-NLS-1$
    options.addOption(new PositionalOptionDefinition(OPT_DEST_WS, "destination-workspace-name", 1, 1), "destination-workspace-name"); //$NON-NLS-1$
    return options;
  }
}
